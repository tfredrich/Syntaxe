 ...
 * @since Oct 8, 2010
 */
public class StringPatternValidationTest
{
	...
	private class Inner
	{
		@StringValidation(name="not-null-string", required=true, pattern="[a-z]{2}")
		private String notNullString;
		
		@StringValidation(name="nullable-string", required=false, pattern="[a-z]{2}", message = "must be a two-character, lower-case string")
		private String nullableString;

		@StringValidation(name="nullable-Collection", required=false, pattern="[a-z]{2}")
		private Collection<String> nullableCollection = new HashSet<String>();
		
		@StringValidation(name = "string-array", required=false, pattern="[a-z]{2}")
		public String[] stringArray = null;

		@StringValidation(name="nullable-map", required=false, pattern="[a-z]{2}", message = "must be a two-character, lower-case string")
		public Map<String, String> nullableMap;

		@StringValidation(name="not-null-map", required=true, pattern="[a-z]{2}")
